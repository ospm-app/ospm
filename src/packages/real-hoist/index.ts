...
export function hoist(
  ...
  opts?:
    | {
        ...
        // This option was added for Bit CLI in order to prevent ospm from overwriting dependencies linked by Bit.
        // However, in the future it might be useful to use it in ospm for skipping any dependencies added by external tools.
